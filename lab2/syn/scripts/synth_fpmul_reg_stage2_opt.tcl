...
compile
optimize_registers
report_timing > reports_synth_fpmul_reg_stage_opt/report_timing_${clk_var}_ns.txt
report_area > reports_synth_fpmul_reg_stage_opt/report_area_clk_${clk_var}_ns.txt
