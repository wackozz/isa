...
#  Created on Mon Nov 15 12:37:10 2021                
#                                                     
#######################################################
...
setLayerPreference allM11Cont -isVisible 1
setLayerPreference allM12Cont -isVisible 1
selectWire 30.8400 39.5150 34.9000 39.5850 3 {q_reg4[5]}
...
deselectAll
selectWire 39.7700 14.5950 42.3100 14.6650 3 mult_55_n29
saveNetlist iir_filter.v
deselectAll
selectWire 5.1300 31.5550 64.4100 31.7250 1 VSS
deselectAll
selectWire 50.2200 18.5150 50.2900 20.1250 2 mult_55_n115
reset_parasitics
extractRC
rcOut -setload iir_filter.setload -rc_corner my_rc
rcOut -setres iir_filter.setres -rc_corner my_rc
...
read_activity_file -format VCD -scope /tb_iir/UUT -start {} -end {} -block {} ../vcd/iir_filter_syn_postplace.vcd
set_power -reset
